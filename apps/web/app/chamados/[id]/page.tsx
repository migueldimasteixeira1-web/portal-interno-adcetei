...
import { TicketChangesDialog, TicketCloseDialog } from "@/features/tickets/TicketConfirmDialogs";
...
import TicketSidePanel from "@/features/tickets/TicketSidePanel";
    ...
    <>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <TicketSidePanel
          ...
          canQuickClose={canQuickClose}
          canCloseNow={canCloseNow}
          hasPendingChanges={hasPendingChanges}
          saving={saving}
          quickAction={quickAction}
          onDraftChange={setDraft}
          onQuickAssign={() => void runQuickAction({ assignee_id: user.id }, "assign")}
          onQuickClose={() => setCloseConfirmOpen(true)}
        />
      </div>

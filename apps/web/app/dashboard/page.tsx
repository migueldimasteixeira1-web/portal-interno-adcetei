...
import { Alert, Badge, Card, EmptyState, SectionHeader, buttonStyles, cn } from "@/components/ui";
import { api } from "@/lib/api";
import { formatDate, relativeTime } from "@/lib/format";
import { canAccessNavItem, moduleLabelForUser, portalModules, type PortalNavItem } from "@/lib/modules";
...
function ModuleCard({ item }: { item: PortalNavItem }) {

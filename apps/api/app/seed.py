...
def seed_database(db: Session) -> None:
    ...
    assets = [
        ...
        _asset(supplier=supplier_iart, equipment_type=eq_type["Computador"], manufacturer=maker["LENOVO"], model=model["NEO30S"], sector=sector["SEGTEA"], serial_number="BRJ2453TZG", status="allocated", assigned_user=user_by_username["servidor"], received_at=_dt(2026, 6, 10), delivered_at=_dt(2026, 6, 12), specifications="Desktop Lenovo Neo 30s, Intel Core i5, 8 GB RAM, SSD 256 GB.", notes="Responsável textual original: Kathlelyn Cristina Santos de Abreu."),
        _asset(supplier=supplier_iart, equipment_type=eq_type["Computador"], manufacturer=maker["LENOVO"], model=model["NEO50S"], sector=sector["Recursos Humanos"], serial_number="DL7829A1", status="allocated", assigned_user=user_by_username["marcelo"], received_at=_dt(2026, 6, 10), delivered_at=_dt(2026, 6, 12), specifications="Desktop Lenovo Neo 50s, Intel Core i5, 16 GB RAM, SSD 512 GB.", notes="Equipamento alocado para teste de movimentação."),

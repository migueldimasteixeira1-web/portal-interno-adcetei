...
def seed_database(db: Session) -> None:
    ...
    users = [
        ...
        User(username="servidor", full_name="Kathlelyn Cristina Santos de Abreu", email="kathlelyn.abreu@sedec.cabofrio.rj.gov.br", password_hash=hash_password("123456"), role="user", secretariat="Secretaria de Desenvolvimento da Cidade", department="SEGTEA", email_verified_at=utc_now()),
